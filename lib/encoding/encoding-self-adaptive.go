...
func MarshalInt64sSelfAdaptive(dst []byte, a []int64, _ uint8) (result []byte, mt MarshalType, firstValue int64) {
	if len(a) == 0 {
	...
	case MarshalTypeSwitching:
		dst, firstValue = marshalInt64Switching(dst, a, 0)
...
func unmarshalInt64sSelfAdaptive(dst []int64, src []byte, mt MarshalType, firstValue int64, itemsCount int) ([]int64, error) {
	...
	case MarshalTypeSwitching:
		dst, err = unmarshalInt64Switching(dst, src, firstValue, itemsCount)
		if err != nil {
