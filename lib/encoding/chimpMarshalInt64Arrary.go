...
func marshalInt64Chimp(dst []byte, a []int64, _ uint8) (result []byte, mt MarshalType, firstValue int64) {
	if len(a) == 0 {
...
func unmarshalInt64Chimp(dst []int64, src []byte, _ MarshalType, _ int64, itemsCount int) ([]int64, error) {
